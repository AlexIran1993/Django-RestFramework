...
SECRET_KEY = 'django-insecure-y^dscslm*&-c8owqh^)pwri0xoeob&cxa2e3kgwl0eoi)$1fr!'
...
INSTALLED_APPS = [
    ...
    'dj_puro',
    'api',
    #Autenticacion por token para rest_framework
...
REST_FRAMEWORK = {
    ...
    #Especificacion del Defualt Permissions Classes
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticated',
    ),
    #Configuracion de swagger de rest_framework
